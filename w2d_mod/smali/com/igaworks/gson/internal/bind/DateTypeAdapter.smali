.class public final Lcom/igaworks/gson/internal/bind/DateTypeAdapter;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 43
    new-instance v0, Lcom/igaworks/gson/internal/bind/DateTypeAdapter$1;

    invoke-direct {v0}, Lcom/igaworks/gson/internal/bind/DateTypeAdapter$1;-><init>()V

    sput-object v0, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->FACTORY:Lcom/igaworks/gson/TypeAdapterFactory;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->enUsFormat:Ljava/text/DateFormat;
    ...
    iput-object v0, p0, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->localFormat:Ljava/text/DateFormat;

    .line 54
    invoke-static {}, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->buildIso8601Format()Ljava/text/DateFormat;

    move-result-object v0

    iput-object v0, p0, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->iso8601Format:Ljava/text/DateFormat;
...
.method private declared-synchronized deserializeToDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->localFormat:Ljava/text/DateFormat;
    ...
    .line 76
    :try_start_1
    iget-object v1, p0, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->enUsFormat:Ljava/text/DateFormat;
    ...
    .line 80
    :try_start_2
    iget-object v1, p0, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->iso8601Format:Ljava/text/DateFormat;
...
.method public bridge synthetic read(Lcom/igaworks/gson/stream/JsonReader;)Ljava/lang/Object;
    ...
    .prologue
    .line 1
    invoke-virtual {p0, p1}, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->read(Lcom/igaworks/gson/stream/JsonReader;)Ljava/util/Date;
...
.method public read(Lcom/igaworks/gson/stream/JsonReader;)Ljava/util/Date;
    ...
    invoke-direct {p0, v0}, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->deserializeToDate(Ljava/lang/String;)Ljava/util/Date;
...
.method public bridge synthetic write(Lcom/igaworks/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/igaworks/gson/internal/bind/DateTypeAdapter;->write(Lcom/igaworks/gson/stream/JsonWriter;Ljava/util/Date;)V

    return-void
.end method

.method public declared-synchronized write(Lcom/igaworks/gson/stream/JsonWriter;Ljava/util/Date;)V
    .locals 2
