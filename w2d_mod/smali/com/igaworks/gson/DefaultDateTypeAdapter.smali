...
.method constructor <init>()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/igaworks/gson/DefaultDateTypeAdapter;-><init>(Ljava/text/DateFormat;Ljava/text/DateFormat;)V
...
.method constructor <init>(Ljava/text/DateFormat;Ljava/text/DateFormat;)V
    ...
    .line 62
    iput-object p1, p0, Lcom/igaworks/gson/DefaultDateTypeAdapter;->enUsFormat:Ljava/text/DateFormat;

    .line 63
    iput-object p2, p0, Lcom/igaworks/gson/DefaultDateTypeAdapter;->localFormat:Ljava/text/DateFormat;
    ...
    iput-object v0, p0, Lcom/igaworks/gson/DefaultDateTypeAdapter;->iso8601Format:Ljava/text/DateFormat;

    .line 65
    iget-object v0, p0, Lcom/igaworks/gson/DefaultDateTypeAdapter;->iso8601Format:Ljava/text/DateFormat;
...
.method private deserializeToDate(Lcom/igaworks/gson/JsonElement;)Ljava/util/Date;
    .locals 4
    ...
    .line 105
    :try_start_4
    iget-object v1, p0, Lcom/igaworks/gson/DefaultDateTypeAdapter;->iso8601Format:Ljava/text/DateFormat;
    ...
    invoke-direct {v1, v3, v0}, Lcom/igaworks/gson/JsonSyntaxException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public bridge synthetic deserialize(Lcom/igaworks/gson/JsonElement;Ljava/lang/reflect/Type;Lcom/igaworks/gson/JsonDeserializationContext;)Ljava/lang/Object;
    ...
    .prologue
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lcom/igaworks/gson/DefaultDateTypeAdapter;->deserialize(Lcom/igaworks/gson/JsonElement;Ljava/lang/reflect/Type;Lcom/igaworks/gson/JsonDeserializationContext;)Ljava/util/Date;
...
.method public deserialize(Lcom/igaworks/gson/JsonElement;Ljava/lang/reflect/Type;Lcom/igaworks/gson/JsonDeserializationContext;)Ljava/util/Date;
    .locals 4
    .param p1, "json"    # Lcom/igaworks/gson/JsonElement;
    ...
    .prologue
    .line 79
    instance-of v1, p1, Lcom/igaworks/gson/JsonPrimitive;
    ...
    .line 82
    :cond_0
    invoke-direct {p0, p1}, Lcom/igaworks/gson/DefaultDateTypeAdapter;->deserializeToDate(Lcom/igaworks/gson/JsonElement;)Ljava/util/Date;
...
.method public bridge synthetic serialize(Ljava/lang/Object;Ljava/lang/reflect/Type;Lcom/igaworks/gson/JsonSerializationContext;)Lcom/igaworks/gson/JsonElement;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/igaworks/gson/DefaultDateTypeAdapter;->serialize(Ljava/util/Date;Ljava/lang/reflect/Type;Lcom/igaworks/gson/JsonSerializationContext;)Lcom/igaworks/gson/JsonElement;
...
.method public serialize(Ljava/util/Date;Ljava/lang/reflect/Type;Lcom/igaworks/gson/JsonSerializationContext;)Lcom/igaworks/gson/JsonElement;
    .locals 3
    ...
    new-instance v1, Lcom/igaworks/gson/JsonPrimitive;

    invoke-direct {v1, v0}, Lcom/igaworks/gson/JsonPrimitive;-><init>(Ljava/lang/String;)V
...
.method public toString()Ljava/lang/String;
    ...
    const-class v1, Lcom/igaworks/gson/DefaultDateTypeAdapter;
