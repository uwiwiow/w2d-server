...
.method expireEntries()V
    ...
    iget-object v1, v1, Lcom/google/common/collect/CustomConcurrentHashMap;->ticker:Lcom/google/common/base/Ticker;

    invoke-interface {v1}, Lcom/google/common/base/Ticker;->read()J
    ...
    invoke-virtual {v1, v0, v2, v3}, Lcom/google/common/collect/CustomConcurrentHashMap;->isExpired(Lcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;J)Z
