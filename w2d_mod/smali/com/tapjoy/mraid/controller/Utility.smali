...
.method private addCalendarEvent(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 346
    iget-object v12, p0, Lcom/tapjoy/mraid/controller/Utility;->mContext:Landroid/content/Context;
    ...
    .line 359
    const-string v12, "content://com.android.calendar/events"

    invoke-static {v12}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v12

    invoke-virtual {v2, v12, v3}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;

    move-result-object v10

    .line 363
    .local v10, "newEvent":Landroid/net/Uri;
    :goto_0
    if-eqz v10, :cond_0
    ...
    .line 370
    const-string v12, "content://com.android.calendar/reminders"
    ...
    const-string v13, "Event added to calendar"
    ...
    .line 361
    .end local v10    # "newEvent":Landroid/net/Uri;
    :cond_1
    const-string v12, "content://calendar/events"
    ...
    .restart local v10    # "newEvent":Landroid/net/Uri;
    goto :goto_0
    ...
    :cond_2
    const-string v12, "content://calendar/reminders"
...
.method public mraidCreateEvent(Ljava/lang/String;)V
    ...
    .local v16, "reminder":Ljava/lang/String;
    const/16 v18, 0x0
    ...
    .line 237
    .local v2, "beginTime":Ljava/util/Calendar;
    invoke-static {}, Ljava/util/Calendar;->getInstance()Ljava/util/Calendar;

    move-result-object v12

    .line 239
    .local v12, "endTime":Ljava/util/Calendar;
    :try_start_0
    ...
    .line 240
    .local v15, "propertiesJSON":Lorg/json/JSONObject;
    ...
    .line 241
    .local v17, "start":Lorg/json/JSONObject;
    const-string v3, "end"
    ...
    .line 243
    .local v11, "end":Lorg/json/JSONObject;
    if-nez v11, :cond_1
    ...
    .line 257
    .end local v11    # "end":Lorg/json/JSONObject;
    .end local v15    # "propertiesJSON":Lorg/json/JSONObject;
    .end local v17    # "start":Lorg/json/JSONObject;
    :goto_1
    ...
    iget-object v3, v0, Lcom/tapjoy/mraid/controller/Utility;->mMraidView:Lcom/tapjoy/mraid/view/MraidView;
