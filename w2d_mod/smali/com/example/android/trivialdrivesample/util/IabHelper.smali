...
.method public handleActivityResult(IILandroid/content/Intent;)Z
    ...
    .prologue
    .line 468
    iget v10, p0, Lcom/example/android/trivialdrivesample/util/IabHelper;->mRequestCode:I
    ...
    invoke-virtual {p0, v10}, Lcom/example/android/trivialdrivesample/util/IabHelper;->checkSetupDone(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v10}, Lcom/example/android/trivialdrivesample/util/IabHelper;->logError(Ljava/lang/String;)V

    .line 478
    new-instance v8, Lcom/example/android/trivialdrivesample/util/IabResult;

    const/16 v10, -0x3ea

    const-string v11, "Null data in IAB result"

    invoke-direct {v8, v10, v11}, Lcom/example/android/trivialdrivesample/util/IabResult;-><init>(ILjava/lang/String;)V

    .line 479
    .local v8, "result":Lcom/example/android/trivialdrivesample/util/IabResult;
    iget-object v10, p0, Lcom/example/android/trivialdrivesample/util/IabHelper;->mPurchaseListener:Lcom/example/android/trivialdrivesample/util/IabHelper$OnIabPurchaseFinishedListener;
    ...
    invoke-interface {v10, v8, v11}, Lcom/example/android/trivialdrivesample/util/IabHelper$OnIabPurchaseFinishedListener;->onIabPurchaseFinished(Lcom/example/android/trivialdrivesample/util/IabResult;Lcom/example/android/trivialdrivesample/util/Purchase;)V
    ...
    .line 483
    .end local v8    # "result":Lcom/example/android/trivialdrivesample/util/IabResult;
    :cond_2
    move-object/from16 v0, p3

    invoke-virtual {p0, v0}, Lcom/example/android/trivialdrivesample/util/IabHelper;->getResponseCodeFromIntent(Landroid/content/Intent;)I
    ...
    sget-object v10, Lcom/orca/dungeonm/WelcomeD;->responseJson:Lorg/json/JSONObject;
    ...
    iget-object v12, p0, Lcom/example/android/trivialdrivesample/util/IabHelper;->mSignatureBase64:Ljava/lang/String;
    ...
    iget-object v11, p0, Lcom/example/android/trivialdrivesample/util/IabHelper;->mPurchasingItemType:Ljava/lang/String;
    ...
    .line 511
    .restart local v8    # "result":Lcom/example/android/trivialdrivesample/util/IabResult;
    iget-object v10, p0, Lcom/example/android/trivialdrivesample/util/IabHelper;->mPurchaseListener:Lcom/example/android/trivialdrivesample/util/IabHelper$OnIabPurchaseFinishedListener;
    ...
    .line 517
    .local v4, "purchase":Lcom/example/android/trivialdrivesample/util/Purchase;
    :try_start_1
    new-instance v5, Lcom/example/android/trivialdrivesample/util/Purchase;

    iget-object v10, p0, Lcom/example/android/trivialdrivesample/util/IabHelper;->mPurchasingItemType:Ljava/lang/String;

    invoke-direct {v5, v10, v6, v1}, Lcom/example/android/trivialdrivesample/util/Purchase;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1

    .line 518
    .end local v4    # "purchase":Lcom/example/android/trivialdrivesample/util/Purchase;
    .local v5, "purchase":Lcom/example/android/trivialdrivesample/util/Purchase;
    :try_start_2
    invoke-virtual {v5}, Lcom/example/android/trivialdrivesample/util/Purchase;->getSku()Ljava/lang/String;

    move-result-object v9

    .line 521
    .local v9, "sku":Ljava/lang/String;
    iget-object v10, p0, Lcom/example/android/trivialdrivesample/util/IabHelper;->mSignatureBase64:Ljava/lang/String;

    invoke-static {v10, v6, v1}, Lcom/example/android/trivialdrivesample/util/Security;->verifyPurchase(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v10, v8, v5}, Lcom/example/android/trivialdrivesample/util/IabHelper$OnIabPurchaseFinishedListener;->onIabPurchaseFinished(Lcom/example/android/trivialdrivesample/util/IabResult;Lcom/example/android/trivialdrivesample/util/Purchase;)V
    ...
    invoke-direct {v11, v12, v13}, Lcom/example/android/trivialdrivesample/util/IabResult;-><init>(ILjava/lang/String;)V

    invoke-interface {v10, v11, v5}, Lcom/example/android/trivialdrivesample/util/IabHelper$OnIabPurchaseFinishedListener;->onIabPurchaseFinished(Lcom/example/android/trivialdrivesample/util/IabResult;Lcom/example/android/trivialdrivesample/util/Purchase;)V
    ...
    .line 529
    .restart local v4    # "purchase":Lcom/example/android/trivialdrivesample/util/Purchase;
    :catch_1
    move-exception v2
    ...
    invoke-static {v7}, Lcom/example/android/trivialdrivesample/util/IabHelper;->getResponseDesc(I)Ljava/lang/String;
    ...
    invoke-direct {v8, v7, v10}, Lcom/example/android/trivialdrivesample/util/IabResult;-><init>(ILjava/lang/String;)V
    ...
    .line 529
    .end local v8    # "result":Lcom/example/android/trivialdrivesample/util/IabResult;
    .restart local v5    # "purchase":Lcom/example/android/trivialdrivesample/util/Purchase;
    :catch_2
    move-exception v2
...
.method queryPurchases(Lcom/example/android/trivialdrivesample/util/Inventory;Ljava/lang/String;)I
    ...
    iget-object v13, v0, Lcom/example/android/trivialdrivesample/util/IabHelper;->mSignatureBase64:Ljava/lang/String;

    invoke-static {v13, v6, v9}, Lcom/example/android/trivialdrivesample/util/Security;->verifyPurchase(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
